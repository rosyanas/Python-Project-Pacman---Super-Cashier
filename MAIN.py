...
milea= Transaction('milea')

milea.transaction_id

milea.add_item('soes', 5, 5000)

milea.check_order()

milea.add_item('tart', 1, 200000)
milea.check_order()

milea.update_item_name('tart','kue ulang tahun')
milea.check_order()

milea.delete_item('kue ulang tahun')
milea.check_order()

milea.add_item('bolu', 2, 40000)

milea.check_order()

milea.update_item_price('bolu',60000)

milea.check_order()

milea.total_price()

milea.update_item_qty('soes',24)
milea.check_order()

milea.add_item('tart',2,200000)
milea.check_order()
milea.total_price()